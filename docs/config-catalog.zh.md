...
来源：[`packages/api/workspace-controller/src/index.ts:52`](../packages/api/workspace-controller/src/index.ts)
...
需要：`agentDefaultModel` · `agents` · `sessions` · `authorization`
...
- `@deepseek-ai/dsh-client-ui-conversation-files`（[`packages/client/ui-conversation-files/src/index.ts`](../packages/client/ui-conversation-files/src/index.ts)）
