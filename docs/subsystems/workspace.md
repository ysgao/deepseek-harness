 ...
 */
@Remote('listEntries') listEntries(request: WorkspaceListEntriesRequest, signal: AbortSignal): Promise<WorkspaceEntryListing>
 ...
 */
@Remote('readFile') readFile(request: WorkspaceReadFileRequest, signal: AbortSignal): Promise<WorkspaceFileContent>
 ...
 */
@Remote('writeFile') writeFile(request: WorkspaceWriteFileRequest, signal: AbortSignal): Promise<WorkspaceWriteFileValue>
 ...
 */
@Remote('gitStatus') gitStatus(request: WorkspaceGitRequest, signal: AbortSignal): Promise<WorkspaceGitStatus>
 ...
 */
@Remote('gitCommitAll') gitCommitAll(request: WorkspaceGitCommitAllRequest, signal: AbortSignal): Promise<WorkspaceGitCommitAllValue>
 ...
 */
@Remote('gitDiscardAll') gitDiscardAll(request: WorkspaceGitRequest, signal: AbortSignal): Promise<WorkspaceGitDiscardAllValue>
 ...
 */
@Remote('gitPullRebase') gitPullRebase(request: WorkspaceGitRequest, signal: AbortSignal): Promise<WorkspaceGitPullRebaseValue>
 ...
 */
@Remote('gitPush') gitPush(request: WorkspaceGitRequest, signal: AbortSignal): Promise<WorkspaceGitPushValue>
 ...
 */
@Remote('gitFileDiff') gitFileDiff(request: WorkspaceGitFileDiffRequest, signal: AbortSignal): Promise<WorkspaceFileDiff>
```
