...
export { WorkspaceController, WorkspaceCreateError, WorkspaceFileBrowseError } from './service.ts'
export type { IWorkspaces, WorkspaceSource } from './service.ts'
export type {
  WorkspaceEntry, WorkspaceEntryListing, WorkspaceFileContent, WorkspaceFileDiff, WorkspaceFileVersion,
