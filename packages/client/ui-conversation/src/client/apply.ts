...
import type {
  ComposerBarInjected, ConversationFileOpener, ConversationInjected, ConversationSessionHeaderInjected,
...
export function apply(ctx: Context): void {
  ...
  // service below; ConversationSession drains it into conversationStore's
  // own bound actions (see files/file-opener.ts for why this indirection is
