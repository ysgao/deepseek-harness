...
type ChatActions = {
  ...
  setOpenFilePath: (draft: ChatStoreState, path: string | null) => void
}
...
export function createChatStore(): EngineStoreHandle<ChatStoreState, ChatActions> {
  return defineStore({
    ...
    init: (): ChatStoreState => ({ selection: null, draft: '', view: null, inspect: null, openFilePath: null }),
    ...
    actions: {
      ...
      setOpenFilePath: (d, path: string | null) => { d.openFilePath = path },
    },
  })
}
