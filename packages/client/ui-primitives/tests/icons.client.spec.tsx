...
describe('ic_ds_ icon set', () => {
  it('exports the full icon set (46 deepsuite + 21 figma extracts + four product glyphs + one drawn placeholder + four hand-drawn stroke glyphs outside those sets)', () => {
