...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('file-too-large'), message: z.string(), details: z.object({ path: z.string(), maxBytes: z.number() }) }),
  z.object({ code: z.literal('file-changed'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('git-not-a-repository'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('git-command-failed'), message: z.string(), details: z.object({ command: z.string() }) }),
  ...
  z.object({ code: z.literal('authorization-not-found'), message: z.string(), details: z.object({ key: z.string() }) }),
  z.object({ code: z.literal('authorization-in-flight'), message: z.string(), details: z.object({ key: z.string() }) }),
