...
import {
  ...
  workspaceGitCommitAllRequestSchema,
  workspaceGitDiscardAllRequestSchema,
  workspaceGitPullRebaseRequestSchema,
  workspaceGitPushRequestSchema,
  workspaceGitFileDiffRequestSchema,
  workspaceGitStatusRequestSchema,
  workspaceInsertBeforeRequestSchema,
  workspaceInsertSessionBeforeRequestSchema,
  workspaceListEntriesRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'workspace.listEntries': { schema: workspaceListEntriesRequestSchema, invoke: (api, r, signal) => api.workspace.listEntries(r, signal) },
  ...
  'workspace.gitPullRebase': { schema: workspaceGitPullRebaseRequestSchema, invoke: (api, r, signal) => api.workspace.gitPullRebase(r, signal) },
