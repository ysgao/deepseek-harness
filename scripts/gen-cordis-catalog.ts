...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AuthorizationStreamFrame: 'credentials.md',
  ...
  WorkspaceEntryListing: 'workspace.md',
  WorkspaceListEntriesRequest: 'workspace.md',
  WorkspaceFileContent: 'workspace.md',
  WorkspaceReadFileRequest: 'workspace.md',
  WorkspaceWriteFileRequest: 'workspace.md',
  WorkspaceWriteFileValue: 'workspace.md',
  WorkspaceGitRequest: 'workspace.md',
  WorkspaceGitStatus: 'workspace.md',
  WorkspaceGitCommitAllRequest: 'workspace.md',
  WorkspaceGitCommitAllValue: 'workspace.md',
  WorkspaceGitDiscardAllValue: 'workspace.md',
  WorkspaceGitPullRebaseValue: 'workspace.md',
  WorkspaceGitPushValue: 'workspace.md',
  WorkspaceFileDiff: 'workspace.md',
  WorkspaceGitFileDiffRequest: 'workspace.md',
