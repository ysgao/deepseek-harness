...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  // `cordis/tree` is the inspector bridge's own message topic and
  // `cordis-tree/get`/`cordis.shadow`/`cordis-client-console` are its op/debug
  // ids, not package references.
