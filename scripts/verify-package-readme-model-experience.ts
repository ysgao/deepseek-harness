...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-conversation-files': { kind: 'none', reason: 'Browser-side file presentation layer that renders workspace content a user opened; it does not change model context.' },
